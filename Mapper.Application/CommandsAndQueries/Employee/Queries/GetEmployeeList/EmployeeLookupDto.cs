    ...
    public class EmployeeLookupDto : IMapWith<Domain.Employee>
    {
        ...
        public void Mapping(Profile profile)
        {
            profile.CreateMap<Domain.Employee, EmployeeLookupDto>()
                ...
                .ForMember(employeeDto => employeeDto.FullName, opt => opt.MapFrom(employee => employee.FullName))
                ...
                .ForMember(employeeDto => employeeDto.EmployeePhotoId, opt => opt.MapFrom(employee => employee.EmployeePhotoId))
